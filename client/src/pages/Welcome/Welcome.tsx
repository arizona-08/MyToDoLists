...
function Welcome() {
    ...
    return (
        <div className='main w-full h-screen relative flex flex-col items-center overflow-hidden'>
            <Navbar/>
            <section className='px-3 w-full md:w-10/12 lg:w-3/4 2xl:w-1/ flex flex-col items-center relative'>
                ...
                <h2 className='text-5xl mt-24 sm:text-4xl md:text-7xl font-bold text-center mb-10'>Ne Soyez Plus Jamais <span className='text-blue-500'>Désorganisé</span></h2>
                ...
                {is_logged &&
                    <div className='w-full flex justify-center mt-11'>
                        <Link to={`/my-lists/${auth_token}`} className='inline-block bg-blue-500 hover:bg-blue-600 hover:border-blue-600 transition-all text-white font-medium py-1 px-2' >Accéder à mes listes</Link>
                    </div>
